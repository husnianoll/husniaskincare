...
<head>
  ...
  <!--[if lt IE 9]>
  <script src="temp/https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js"></script>
  <script src="temp/https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
  <![endif]-->
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="temp/dist/img/user4-128x128.jpg" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="temp/dist/img/user3-128x128.jpg" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="temp/dist/img/user2-160x160.jpg" alt="user image" class="offline">
...
<!-- Morris.js charts -->
<script src="temp/bower_components/raphael/raphael.min.js"></script>
<script src="temp/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
